...
function updateCanvas() {
    ...
    var random_number = Math.floor((Math.random()*quick_draw_data_set.length) + 1);
    console.log(sketch);
    new document.getElementById("sketch_to_be_drawn").innerHTML = sketch;
}
...
function check_sketch() {
    timer_counter += 1;
    document.getElementById("limited_time").innerHTML = "Timer : " + timer_counter;
